...
const TemplateInput_1 = require("./interfaces/TemplateInput");
let GeneratorService = class GeneratorService {
    ...
    runTemplate(template) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (template.input === TemplateInput_1.TemplateInput.One) {
                // Create results stack
                const output = [];
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const template of templates) {
                if (template.input === TemplateInput_1.TemplateInput.One) {
                    ...
                    output.push(yield this._all(template));
                }
            }
            return output;
        });
    ...
    path(template, model) {
        if (template.input === TemplateInput_1.TemplateInput.One) {
            if (!model) {
                throw new Error('IModel should be defined for this template');
            }
    ...
    _path(path, model = null) {
        ...
        // Apply replacements
        path = path.replace(/{model\.hyphen}/g, this.stringService.format(model.name, interfaces_1.SentenceFormat.SlugHyphen));
        path = path.replace(/{model\.hyphenUpper}/g, this.stringService.format(model.name, interfaces_1.SentenceFormat.SlugHyphenUpperCase));
        path = path.replace(/{model\.underscore}/g, this.stringService.format(model.name, interfaces_1.SentenceFormat.SlugUnderscore));
        path = path.replace(/{model\.underscoreUpper}/g, this.stringService.format(model.name, interfaces_1.SentenceFormat.SlugUnderscoreUpperCase));
        path = path.replace(/{model\.oneWord}/g, this.stringService.format(model.name, interfaces_1.SentenceFormat.SlugOneWord));
        path = path.replace(/{model\.upperCamel}/g, this.stringService.format(model.name, interfaces_1.SentenceFormat.UpperCamelCase));
        path = path.replace(/{model\.lowerCamel}/g, this.stringService.format(model.name, interfaces_1.SentenceFormat.LowerCamelCase));
        return path;
    }
    /**
     ...
     * @private
     */
    _explicitModel(models, model, depth = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            // Create object
            ...
            if (depth === 0) {
                ...
                const promisesRef = fields.filter((f) => (f.type === interfaces_1.FieldType.Entity) && f.reference)
                    .map((field) => {
...
GeneratorService = __decorate([
    typedi_1.Service(),
    __metadata("design:paramtypes", [typeof (_a = typeof interfaces_1.StringService !== "undefined" && interfaces_1.StringService) === "function" ? _a : Object, typeof (_b = typeof interfaces_1.HpfGeneratorService !== "undefined" && interfaces_1.HpfGeneratorService) === "function" ? _b : Object, typeof (_c = typeof interfaces_1.JavaScriptGeneratorService !== "undefined" && interfaces_1.JavaScriptGeneratorService) === "function" ? _c : Object])
], GeneratorService);
