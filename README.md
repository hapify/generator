...
This package allows to generate code using Hapify models and Hapify or JavaScript code templates.

## Hapify Syntax

For documentation about Hapify Syntax, please refer to [syntax](https://www.hapify.io/documentation/syntax).

## Model usage within a template

We will describe the structure of the object that represent a model when writing a template.

Before reading this, you should have a look to the [key-concepts](https://www.hapify.io/documentation/key-concepts) section.

### Within the templates

The following objects will be available in a JavaScript template.
